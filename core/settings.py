...
ALLOWED_HOSTS = ['localhost,127.0.0.1','[::1]','django-images.azurewebsites.net']
CSRF_TRUSTED_ORIGINS = ['https://django-images.azurewebsites.net']
...
DATABASES = {
    'default': {
        ...
        'USER': 'maamoun.mribah@eniso.u-sousse.tn',
        'PASSWORD': '29618730Ab#',
